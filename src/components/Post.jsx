...
export default function Post(props){
    ...
    return (
        <article className="duration-300 p-2.5 border border-[#6e98ba] sm:p-5 h-fit w-auto bg-white bg-opacity-5 cursor-pointer rounded-xl shadow-lg hover:bg-opacity-30 hover:-mt-1 hover:mb-2 hover:shadow-xl ">
